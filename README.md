## Optic Nerve
Optic Nerve is a desktop app which controls DSLR cameras via USB to initiate new pictures, download images, and change various camera capture settings such as ISO, F-Stop, and Exposure (Shutter). 
